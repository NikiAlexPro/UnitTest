...
//
//
// Тестирование ПО. Лабораторная 13 + Лабораторная 14
//
//
//
...
namespace Csharp_lab_13
{
    public partial class Form1 : Form
    {
        ...
        private void buttonTeacher_Click(object sender, EventArgs e)
        {
            ...
            if (modelTeacher.Teachers.Find(teacher.first_name) != null 
                && modelTeacher.Teachers.Find(teacher.last_name) != null 
                && modelTeacher.Teachers.Find(teacher.) != null
                )
            {
