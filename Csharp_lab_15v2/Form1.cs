    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            try
            {
                ...
                comboBoxGROUP.DataSource = Mock.GroupDB.GetGroups();
            }
            catch(Exception ex)
            {
        ...
        private void buttonTeacher_Click(object sender, EventArgs e)
        {
            ...
            var gr = Mock.GroupDB.GetGroups()[comboBoxGROUP.SelectedIndex];
            //teacher.Group = gr;
            //teacher.special = gr.special;
            try
            {
                Mock.AddTeacherDB.AddTeacher(gr, textBoxNAME.Text, textBoxLSTNAME.Text, textBoxPHONE.Text, textBoxEXP.Text);
            }
            catch(Exception)
            {
        ...
        private void buttonSearch_Click(object sender, EventArgs e)
        {
            try
            {
                var teacher = Mock.SearchDB.GetTeacher(textBoxSearchText.Text); if (teacher != null)
                {
